      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 md:p-14 space-y-8 md:space-y-10">
        ...
        <div className="w-full flex justify-between items-center mb-8">
          ...
          <div className="text-sm flex gap-1">
            ...
            <Link href="/login" className="font-bold text-neutral-600 hover:text-neutral-800">
              Join
            </Link>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <button
            ...
            className="w-full py-3 bg-blue-500 text-white font-semibold text-sm rounded-md hover:bg-blue-600 transition"
          >
            Create Account
          </button>
        </div>
